...
import (
	...
	"encoding/hex"
	"fmt"
	"github.com/Gitforxuyang/proto-validaotr/cmd/protoc-gen-av/generator/internal/remap"
	"go/ast"
	"go/build"
	"go/parser"
	"go/printer"
...
func (g *Generator) Error(err error, msgs ...string) {
	...
	log.Print("protoc-gen-av: error:", s)
	os.Exit(1)
}
...
func (g *Generator) GenerateAllFiles() {
	...
	for _, file := range g.allFiles {
		...
		if g.annotateCode {
			...
			g.Response.File = append(g.Response.File, &plugin.CodeGeneratorResponse_File{
				Name:    proto.String(file.goFileName(g.pathType) + ".av"),
...
func (g *Generator) generateHeader() {
	g.P("// Code generated by protoc-gen-av. DO NOT EDIT.")
